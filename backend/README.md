...
## Project Structure
    ...
    ├── ideapros_llc_pickup_31944  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_pickup_31944`
...
2. Clone this repo and `cd ideapros_llc_pickup_31944`
